...
const PesquisaPorOab = () => {
  console.log('Passou pelo PesquisaPorOab')
  ...
  return (
    ...
    >
      <div className="text-center py-3 mt-3">
        <h3 style={{ textShadow: '1px 1px 1px lightgrey' }}>Pesquisa publicações pelo numero da OAB</h3>
        <br>/<br>
        </br></br>
        <h3 style={{ textShadow: '1px 1px 1px lightgrey' }}>Em implantação</h3>
