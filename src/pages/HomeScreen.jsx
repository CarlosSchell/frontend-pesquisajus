      ...
      <Row>
        <Col sm={12} style={{ backgroundColor: ' #eaeded ', width: '420px', minHeight: '89.7vh' }}>
          ...
          <div  style={{ marginLeft: '20%', width: '60%', fontSize: '24px', textAlign: 'center' }}>
              ...
              <div>O sistema possui também uma API - interface para a consulta automatizada de dados - e também uma área para baixar arquivos de dados para voce poder fazer as suas próprias pesquisas e análises</div>
              <br></br>
              ...
              <div>Versão 1.0.0 - Maio de 2021</div>
          </div>
        </Col>
      </Row>
    </Container>
