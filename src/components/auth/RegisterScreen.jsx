...
const RegisterScreen = () => {
  ...
  // Page Actions
  const validateForm = () =>
    email.length > 0 && password.length > 5 && password.length <= 20 && password === passwordConfirm

  const registerUserScreen = async () => {
    try {
      ...
      //   console.log('Entrou no catch - Caso 2 : The request was made
      // but no response was received')
      //   // The request was made but no response was received
      //   // `error.request` is an instance of XMLHttpRequest in
      // the browser and an instance of
      //   // http.ClientRequest in node.js
      //   console.log(error.request)
      // } else {
      //   console.log('Entrou no catch - Caso 3 : Something happened
