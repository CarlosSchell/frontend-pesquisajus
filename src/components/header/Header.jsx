...
import SvgProcessos from './SvgProcessos'

import SvgDiversos from './SvgDiversos'
import SvgUsuario from './SvgUsuario'
  ...
  return (
    ...
    >
      ...
      >
        <LinkContainer
          to="/pesquisapornome"
          style={{ margin: '19px 0px 10px 10px', padding: '0px 0px 0px 0px' }}
        >
          <Nav.Link>
            <SvgPesquisar />
          </Nav.Link>
        ...
        <LinkContainer
          to="/meusprocessos"
          style={{ margin: '18px 4px 10px 10px', padding: '0px 0px 0px 0px' }}
        >
          <Nav.Link>
            <SvgProcessos />
          </Nav.Link>
